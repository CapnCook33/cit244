...
public class GridPaneImages extends Application
{
   ...
   public void start(Stage primaryStage)
   {
      ...
      Image moonImage = new Image("Images/Moon.jpg");
      Image shipImage = new Image("Images/Ship.jpg");
      Image sunsetImage = new Image("Images/Sunset.jpg");
      Image flowerImage = new Image("Images/Flower.jpg");
